    ...
    <section className={styles.section}>
      <div className={styles.card}>
        ...
        <div className={styles.left}>
          <h3 className={styles.quote}>&ldquo;{t('testimonial.quote')}&rdquo;</h3>
          <div className={styles.author}>
            <div className={styles.avatar}>
              <Image src="/avbpetit.png" alt={t('testimonial.avatarAlt')} width={48} height={48} className={styles.avatarImg} />
            </div>
            <div>
